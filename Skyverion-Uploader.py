...
root = tkinter.Tk()
print('Upload Skyverion photos via GUI')
root.title('Skyverion Uploader')
...
def post():
    ...
    # print(f"{tagname:25}: {value}")
        ...
        title = justDate
        print(title)
        takenOn = "DJI Spark"  # input("What was this photo taken on? : ")

        image = Image.open(fileName)
        #print(image.model)

         
        allPhotos = open("Doug-Mathiowetz.html", "a")
        ...
        with open("Doug-Mathiowetz.html", 'r+') as f:  # r+ does the work of rw
            lines = f.readlines()
