...
// var geoLat1 = 33.895847;
// var geoLng1 = -118.22007;
// var coordinates = geoLat1.toString() + "," + geoLng1.toString();
...
function getPosSuccess(pos) {
  ...
  geoLoc.innerHTML = coordinates1;
  console.log("Your current coordinates are " + coordinates1);

// Weather data API
var coordinates1 = document.getElementById("geoLoc").textContent;
...
fetch(
  ...
  .then((aqi) => {
    ...
    if (windspeed >= 20) {
      header.innerHTML = "Too windy to fly";
    } else {
