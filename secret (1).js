...
function pressed(e) {
  ...
  var text = document.getElementById("jr")
    .value;
  ...
  if (text === "text blue") {
    ...
    document.getElementById('li')
      .style.backgroundImage = "url('long range model s.jpg')";
    tesla.innerHTML = "2021Long Range Model S <br />";
    header.innerHTML = "19' Tempest Wheels<br /> Dual Motor AWD<br />3.1s 0-60<br /> 155mph top speed<br /> 412mi range<br /><span title='Enables your car to steer, accelerate and brake automatically for other vehicles and pedestrians within its lane.'>Autopilot Included &#10003 </span><br /><span title='Navigate on Autopilot: automatic driving from highway on-ramp to off-ramp including interchanges and overtaking slower cars. Auto Lane Change: automatic lane changes while driving on the highway. Autopark: both parallel and perpendicular spaces. Summon: your parked car will come find you anywhere in a parking lot. Really. Traffic Light and Stop Sign Control: assisted stops at traffic controlled intersections.'>Full Self Driving Capabilities</span><br />Yoke Steering &#10003";
    document.getElementById('header')
      .style.color = "black";
    document.getElementById('tesla')
      .style.fontFamily = "Tesla";
    /*var url = "long range model s.jpg";
    var div = document.getElementById("li");
    div.style.backgroundImage = "url('long range model s.jpg')";
    div.style.image = "100%";
    div.style.height = "100%";
    test.style.backgroundImage = "url('long range model s.jpg')";*/
  } else if (text === "plaid model s") {
    document.getElementById('li')
      .style.backgroundImage = "url('2021 plaid model s.jpg')";
    tesla.innerHTML = "<span title='only thing beyond ludicrous is plaid'>2021Plaid Model S</span><br />"
    header.innerHTML = "21' Arachnid Wheels <br />Tri Motor AWD<br />1.99s 0-60 with Plaid Mode<br /> 200mph top speed<br /> 390mi range <br /><span title='Enables your car to steer, accelerate and brake automatically for other vehicles and pedestrians within its lane.'>Autopilot Included &#10003<span><br /><span title='Navigate on Autopilot: automatic driving from highway on-ramp to off-ramp including interchanges and overtaking slower cars. Auto Lane Change: automatic lane changes while driving on the highway. Autopark: both parallel and perpendicular spaces. Summon: your parked car will come find you anywhere in a parking lot. Really. Traffic Light and Stop Sign Control: assisted stops at traffic controlled intersections.'> Full Self Driving Capabilities</span><br />Yoke Steering &#10003<br /><br /><u>Plaid Upgrades</u><ul><li>Quickest accerating car in production today</li><li>1/4 mile: 9.23@155mph trap speed</li><li>1,020 horsepower</li><li>Carbon Sleeved Rotors</li><li>Torque Vectoring</li>"
    document.getElementById('header')
      .style.color = "white";
    document.getElementById('tesla')
      .style.color = "red";
    ...
    document.getElementById('li')
      .style.backgroundImage = "url('2021 plaid+ model s.png')";
    tesla.innerHTML = "<span title='Only thing beyond Ludicrous is Plaid and the only thing beyond Plaid is Plaid+ lol'>2021Plaid+ Model S</span><br />"
    header.innerHTML = "21' Arachnid Wheels<br />Tri-Motor AWD<br />200mph top speed<br />520+ mile range<br /><span title='Enables your car to steer, accelerate and brake automatically for other vehicles and pedestrians within its lane.'>Autopilot Included &#10003</span><br /><span title='Navigate on Autopilot: automatic driving from highway on-ramp to off-ramp including interchanges and overtaking slower cars. Auto Lane Change: automatic lane changes while driving on the highway. Autopark: both parallel and perpendicular spaces. Summon: your parked car will come find you anywhere in a parking lot. Really. Traffic Light and Stop Sign Control: assisted stops at traffic controlled intersections.'>Full Self Driving Capabilites</span><br /><br /><u>Plaid+ Upgrades</u><ul><li>Quickest 0-60 and 1/4 mile acceleration of any production car <i>ever</i></li><li>0-60 mph: <1.99s</li><li>1/4 mile: <9.0s</li><li>1,100+ horsepower</li><li><i>Three</i> high performance motors</li><li>Carbon-sleeved rotors</li><li>Torque vectoring</li><br />Yoke Steering &#10003";
    document.getElementById('header')
      .style.color = "red";
    document.getElementById('tesla')
      .style.fontFamily = "Tesla";
    ...
    document.getElementById('li')
      .style.backgroundImage = "url('long range model y.jpg')"
    tesla.innerHTML = "2021 Long Range Model Y";
    header.innerHTML = "19' Gemini Wheels<br /> Dual Motor AWD<br />4.8s 0-60<br /> 4.3s 0-60 with acceleration boost<br />135mph top speed<br /> 326mi range<br /><span title='Enables your car to steer, accelerate and brake automatically for other vehicles and pedestrians within its lane.'>Autopilot Included &#10003</span><br /><span title='Navigate on Autopilot: automatic driving from highway on-ramp to off-ramp including interchanges and overtaking slower cars. Auto Lane Change: automatic lane changes while driving on the highway. Autopark: both parallel and perpendicular spaces. Summon: your parked car will come find you anywhere in a parking lot. Really. Traffic Light and Stop Sign Control: assisted stops at traffic controlled intersections.'>Full Self-Driving Capabilities</span>   "
    document.getElementById('header')
      .style.color = "black";
    document.getElementById('tesla')
      .style.fontFamily = "Tesla";
    ...
    document.getElementById('li')
      .style.backgroundImage = "url('model y long range.jpeg')";
    tesla.innerHTML = "2021 Performance Model Y";
    header.innerHTML = "21' Uberturbine Wheels<br />Performance Breaks<br />Lowered Suspension<br />Aluminum Alloy Pedals<br />Dual Motor AWD<br />3.5s 0-60<br />155 mph top speed<br />303mi range <br /><span title='Enables your car to steer, accelerate and brake automatically for other vehicles and pedestrians within its lane.'>Autopilot Included &#10003</span><br /><span title='Navigate on Autopilot: automatic driving from highway on-ramp to off-ramp including interchanges and overtaking slower cars. Auto Lane Change: automatic lane changes while driving on the highway. Autopark: both parallel and perpendicular spaces. Summon: your parked car will come find you anywhere in a parking lot. Really. Traffic Light and Stop Sign Control: assisted stops at traffic controlled intersections.'>Full Self-Driving Capabilities</span>"
    document.getElementById('header')
      .style.color = "black";
    document.getElementById('tesla')
      .style.fontFamily = "Tesla";
    ...
    document.getElementById('li')
      .style.backgroundImage = "url('cybertruck.jpg')"
    tesla.innerHTML = "Single Motor Cybertruck";
    header.innerHTML = "Single Motor RWD <br /> <6.5s 0-60<br /> 7,500+lbs Towing Capacity"
    document.getElementById('header')
      .style.color = "black";
    document.getElementById('tesla')
      .style.fontFamily = "Tesla";
    ...
    document.getElementById('li')
      .style.backgroundImage = "url('semi.jpg')";
    tesla.innerHTML = "Tesla Semi";
    header.innerHTML = "Four Independent Motors<br />20s 0-60 with 80,000lb load<br /><span title='The drag Coefficient of the 2 million dollar Bugatti Chiron that is known for being aerodynamic is 0.38'>0.36 Drag Coefficient</span><br />300 and 500 mile range options<br /> Center Pilots Seat"
    document.getElementById('header')
      .style.color = "black";
    document.getElementById('tesla')
      .style.fontFamily = "Tesla";
    ...
    header.innerHTML = '"background" + (primary color of your choice)<br />"text" + (primary color of your choice)<br />"Josh"<br />"Jolene"<br />"Kendra"<br />"kya"<br />"Kalisia"<br />"standard range (tesla model of your choice) example-> "standard range model 3"<br />"long range (tesla model of your choice)<br />"performance" (tesla model of your choice)<br />"plaid (tesla model of your choice)"<br />"plaid+ model s"<br />"single motor cybertruck"<br />"semi"<br />"tesla font"';
    document.getElementById('header')
      .style.color = "black";
...
//       const key = e.keyCode || e.which;
      if (now.getMonth() === keaganbday.getMonth() && now.getDate() === keaganbday.getDate()) {
        console.log(now);
        document.body.classList.add('keagan-bday-background');
      }
      jr.addEventListener('keypress', function(e) {
      ...
      /*
              ...
              */
      function alertTest() {
        alert('Welcome to my site! Type "help" for help.');
        //alert("")
      }
      alertTest();