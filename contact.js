...
var greeting = "LET'S GET IN TOUCH!";
console.log(hourNow);
/*
if (hourNow > 18) {
  greeting = "GOOD EVENING, LET'S GET IN TOUCH!";
} else if (hourNow > 12) {
  greeting = "GOOD AFTERNOON, LET'S GET IN TOUCH!";
} else if (hourNow > 0) {
  greeting = "GOOD MORNING, LET'S GET IN TOUCH!";
} else {
  greeting = "Welcome, LET'S GET IN TOUCH!";
}*/
header.innerHTML = greeting;
